 ...
 * lib/timeTracking.ts) — this page only manages tier-2 rows.
 *
...
export default function AdminTimeCategoriesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Time Categories</h1>
